 ...
 * @LastEditors: lyf
 * @LastEditTime: 2021-05-12 14:52:15
...
platform.set('3', { title: '案例', icon: DingtalkOutlined });
...
routes.set('2002', { title: 'antd模板2', path: '/antd/case2', component: TutorialAntd.TutorialAntdCase2 });

// mobile
routes.set('3001', { title: '抽奖', path: '/mobile/draw', component: TutorialReact.MobileDraw });
